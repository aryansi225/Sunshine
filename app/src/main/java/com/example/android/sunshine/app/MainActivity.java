        ...
        if (findViewById(R.id.weather_detail_container) != null) {
            ...
            if (savedInstanceState == null) {
                getSupportFragmentManager().beginTransaction()
                        .replace(R.id.weather_detail_container, new Detail_ActivityFragment(), DETAILFRAGMENT_TAG)
                        .commit();
                }
        } else {
            mTwoPane = false;
...
//        setSupportActionBar(toolbar);
    ...
    protected void onResume() {
        ...
        if (location != null && !location.equals(mLocation)) {
            ...
            Detail_ActivityFragment df = (Detail_ActivityFragment)getSupportFragmentManager().findFragmentByTag(DETAILFRAGMENT_TAG);
            if ( null != df ) {
    ...
    public void onItemSelected(Uri contentUri) {
        if (mTwoPane) {
            ...
            args.putParcelable(Detail_ActivityFragment.DETAIL_URI, contentUri);
